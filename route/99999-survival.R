...
rfpredict <- function(req, res) {
  ...
  source("shelf/99999-survival/src/predict.R", local=TRUE)
...
function(req, res) {
  library(jsonlite)
  inputs <- fromJSON('shelf/99999-survival/src/testdata.json')
...
function(req, res) {
  library(jsonlite)
  fromJSON('shelf/99999-survival/src/schema.json')
}
